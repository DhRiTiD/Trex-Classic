...
function setup() {
  ...
  ground = createSprite(width/2,height-140,width, 20);
  ...
  invisibleGround = createSprite(width/2,height-130,width,10);
...
function draw() {
 ...
 if(touches.length0 || keyDown("SPACE")) {      
      reset();
      touches = [];
    }
  }
...
function spawnObstacles() {
  if (frameCount % 60 === 0) {
    var obstacle = createSprite(600,height-155, 10, 40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width+20,height-300);
